            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent1">
                    <ul id="navUl" class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        </li>--%><asp:Label ID="Label4" runat="server" Text=""></asp:Label>
        ...
        <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="10000">
                    <img style="opacity: 0.7; /*border-bottom-right-radius: 80%; border-bottom-left-radius: 80%; */" src="Image/home3.jpg" class="d-block w-100" alt="..." />
                ...
                <div class="carousel-item" data-bs-interval="2000">
                    <img style="opacity: 0.7; /*border-bottom-right-radius: 80%; border-bottom-left-radius: 80%; */" src="Image/homehome3.jpg" class="d-block w-100" alt="..." />
                    <div class="carousel-caption d-none d-md-block">
