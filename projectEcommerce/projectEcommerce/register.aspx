                ...
                <div id="form">
                    <div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="formGroupExampleInput" required="required" placeholder="" runat="server" />
                        </div>
                        <br />

                        <div class="form-group">
                            <label for="exampleFormControlInput1">Email </label>
                            <input type="email" class="form-control" id="exampleFormControlInput1" required="required" runat="server" />
                        </div>
                        <br />
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Phone</label>
                            <input type="tel" class="form-control" id="formGroupExampleInput2" required="required" placeholder="enter your number" runat="server" />
                        </div>
                        <br />
                        <%--                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="select" required="required" runat="server">
                                <option>Irbid</option>
                                <option>Zarqa</option>
                                <option>Amman</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="exampleInputPassword1" required="required" placeholder="Password" runat="server" />
                        </div>
                        <br />
                        <div class="form-group">
                            <label for="exampleInputPassword1">Confirm Password</label>
                            <input type="password" class="form-control" id="exampleInputPassword2" required="required" placeholder="Password" runat="server" />
                        </div>
                        <br />
